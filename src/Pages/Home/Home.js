    ...
    <div className='home'>
        <div className='home__Container'>
            ...
            <div className='home__row'>
              ...
              {storeItems2().map((item) => <Product key={item.id} title={item.title} price={item.price} image={item.image} rating={item.rating} id={item.id} />)}

            </div>

            <div className='home__row'>

              {storeItems3().map((item) => <Product key={item.id} title={item.title} price={item.price} image={item.image} rating={item.rating} id={item.id} />)}

            </div>
            <div className='home__row'>

              {storeItems4().map((item) => <Product key={item.id} title={item.title} price={item.price} image={item.image} rating={item.rating} id={item.id} />)}
